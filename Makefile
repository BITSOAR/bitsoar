#############################################################################
# Makefile for building: BitSoar-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ? 7 7 18:56:18 2017
# Project:  BitSoar-qt.pro
# Template: app
# Command: c:\qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile BitSoar-qt.pro
#############################################################################
...
Makefile: BitSoar-qt.pro  ../../QT/4.8.6/mkspecs/default/qmake.conf ../../QT/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile BitSoar-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/coin/BitSoar/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/coin/BitSoar/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/coin/BitSoar/src/leveldb/libleveldb.a: FORCE
